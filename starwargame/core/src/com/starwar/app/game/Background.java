...
import static com.starwar.app.screen.ScreenManager.*;
...
public class Background {
    ...
    private class Star {
        ...
        public Star() {
            this.position = new Vector2(MathUtils.random(-200, SPACE_WIDTH + 200),
                    MathUtils.random(-200, SPACE_HEIGHT + 200));
        ...
        public void update(float dt) {
            ...
            if (position.x < -200) {
                position.x = SPACE_WIDTH + 200;
                position.y = MathUtils.random(0, SPACE_HEIGHT);
                scale = Math.abs(velocity.x / 40f) * 0.8f;
            }
        }
    }
    ...
    public Texture getTextureCosmos() {
        return textureCosmos;
    }
